...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES["genre-img"]["tmp_name"]) && $_FILES["genre-img"]["tmp_name"] !== '') {
    ...
    if ($_FILES["genre-img"]["size"] > 5000000) {
        $uploadOk = 0;
    }
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["genre-img"]["tmp_name"], $uniqueFileName)) {
